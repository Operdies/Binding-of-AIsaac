...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_gs')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_gs')
    _gs = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_gs', [dirname(__file__)])
        except ImportError:
            import _gs
            return _gs
        if fp is not None:
            try:
                _mod = imp.load_module('_gs', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _gs = swig_import_helper()
...
ImageFromDisplay = _gs.ImageFromDisplay
